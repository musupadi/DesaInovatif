...
public class SuratPernyataanOrangTuaWaliFragment extends Fragment {
    ...
    EditText Nama,Pekerjaan,NIK,NoKK,Alamat,NoHP,NamaDari,NIKDari;
    public SuratPernyataanOrangTuaWaliFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_surat_pernyataan_orang_tua_wali, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        NoKK = view.findViewById(R.id.etNoKK);
        NoHP = view.findViewById(R.id.etNoHP);
        NamaDari = view.findViewById(R.id.etNamaDari);
        NIKDari = view.findViewById(R.id.etNIKDari);
    ...
    private void Logic(){
        ...
        final Call<Ress> data =api.PostSuratPernyataanDampakOrtuTerdampakCOVID(destiny.AUTH(),destiny.Kunci(),ID,ID_Desa,IDS,"0",NamaSurat.getText().toString(),NoteSurat.getText().toString(),
                Nama.getText().toString(),NIK.getText().toString(),NoHP.getText().toString(),NoKK.getText().toString(),
                Pekerjaan.getText().toString(),Alamat.getText().toString(),NamaDari.getText().toString(),NIKDari.getText().toString());
