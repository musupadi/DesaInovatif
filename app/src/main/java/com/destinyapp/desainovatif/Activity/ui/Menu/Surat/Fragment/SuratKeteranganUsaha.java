...
public class SuratKeteranganUsaha extends Fragment {
    //Cut Here
    Button Submit;
    Destiny destiny;
    //Main
    ...
    EditText Nama,TTL,NIK,Alamat,AlamatUsaha,JenisUsaha;
    Spinner JenisKelamin,Hari,Bulan,Tahun;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_surat_keterangan_usaha, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AlamatUsaha = view.findViewById(R.id.etAlamatUsaha);
        JenisUsaha = view.findViewById(R.id.etJenisUsaha);
    ...
    private void Logic(){
        ...
        final Call<Ress> data =api.PostSuratKeteranganUsaha(destiny.AUTH(),destiny.Kunci(),ID,ID_Desa,IDS,"0",NamaSurat.getText().toString(),NoteSurat.getText().toString(),
                Nama.getText().toString(),destiny.TTL(TTL,Tahun,Bulan,Hari),JenisKelamin.getSelectedItem().toString(),
                NIK.getText().toString(),Alamat.getText().toString(),AlamatUsaha.getText().toString(),JenisUsaha.getText().toString());
