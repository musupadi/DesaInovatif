...
public class SuratKuasaFragment extends Fragment {
    //Cut Here
    Button Submit;
    Destiny destiny;
    //Main
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_surat_kuasa, container, false);
    }
    ...
    private void Logic(){
        ...
        final Call<Ress> data =api.PostSuratKuasa(destiny.AUTH(),destiny.Kunci(),ID,ID_Desa,IDS,"0",NamaSurat.getText().toString(),NoteSurat.getText().toString(),
                Nama.getText().toString(),TTL.getText().toString()+", "+destiny.Tanggal(Tahun,Bulan,Hari),JenisKelamin.getSelectedItem().toString(),Pekerjaan.getText().toString(),Alamat.getText().toString());
