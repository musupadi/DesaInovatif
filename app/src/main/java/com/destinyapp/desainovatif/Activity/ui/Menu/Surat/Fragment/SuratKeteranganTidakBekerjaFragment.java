...
public class SuratKeteranganTidakBekerjaFragment extends Fragment {
    //Cut Here
    Button Submit;
    Destiny destiny;
    //Main
    ...
    EditText Nama,TTL,Pekerjaan,NoKTP,Alamat;
    Spinner JenisKelamin,Hari,Bulan,Tahun,HariTidakBekerja,BulanTidakBekerja,TahunTidakBekerja,Agama;

    public SuratKeteranganTidakBekerjaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_surat_keterangan_tidak_bekerja, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        HariTidakBekerja = view.findViewById(R.id.spHariTidakBekerja);
        BulanTidakBekerja = view.findViewById(R.id.spBulanTidakBekerja);
        TahunTidakBekerja = view.findViewById(R.id.spTahunTidakBekerja);
    ...
    private void Logic(){
        ...
        final Call<Ress> data =api.PostSuratKeteranganTidakBekerja(destiny.AUTH(),destiny.Kunci(),ID,ID_Desa,IDS,"0",NamaSurat.getText().toString(),NoteSurat.getText().toString(),
                Nama.getText().toString(),destiny.TTL(TTL,Tahun,Bulan,Hari),JenisKelamin.getSelectedItem().toString(),
                Agama.getSelectedItem().toString(),Pekerjaan.getText().toString(),NoKTP.getText().toString(),Alamat.getText().toString(),destiny.Tanggal(TahunTidakBekerja,BulanTidakBekerja,HariTidakBekerja));
