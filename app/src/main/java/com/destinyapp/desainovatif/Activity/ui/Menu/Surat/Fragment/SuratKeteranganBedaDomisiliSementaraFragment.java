...
public class SuratKeteranganBedaDomisiliSementaraFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        NamaKampung = view.findViewById(R.id.etNamaKampung);
        RT = view.findViewById(R.id.etRT);
        RW = view.findViewById(R.id.etRW);
        TinggalSejak = view.findViewById(R.id.etTinggalSejak);
