...
public class AdapterListUserRW extends ArrayAdapter<DataModel> {

    public AdapterListUserRW(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNomor_rw());
            textId.setText(String.valueOf(currentItem.getId_rw()));
        }
