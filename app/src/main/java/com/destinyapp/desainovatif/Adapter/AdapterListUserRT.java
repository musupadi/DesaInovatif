...
public class AdapterListUserRT extends ArrayAdapter<DataModel> {

    public AdapterListUserRT(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(" " + currentItem.getNama_user());
            textId.setText(String.valueOf(currentItem.getId_user()));
        }
