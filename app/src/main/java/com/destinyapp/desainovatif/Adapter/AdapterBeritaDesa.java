...
public class AdapterBeritaDesa extends RecyclerView.Adapter<AdapterBeritaDesa.HolderData> {
    ...
    Destiny destiny;
    public AdapterBeritaDesa(Context ctx, List<DataModel> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View layout = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_berita_desa,viewGroup,false);
