...
public class AdapterListRT extends ArrayAdapter<DataModel> {

    public AdapterListRT(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNomor_rt());
            textId.setText(String.valueOf(currentItem.getId_rt()));
        }
