...
public class AdapterAllBerita extends RecyclerView.Adapter<AdapterAllBerita.HolderData> {
    ...
    Destiny destiny;
    public AdapterAllBerita(Context ctx, List<Data> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View layout = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_berita_all,viewGroup,false);
